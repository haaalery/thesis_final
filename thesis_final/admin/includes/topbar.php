<?php
/**
 * Admin Topbar Navigation - COMPLETE FIXED VERSION
 * File: thesis_final/admin/includes/topbar.php
 * FIXED: Real-time notification updates every 30 seconds + Click to mark as read
 */
...
<div class="topbar">
    <div class="topbar-left">
        ...
        <div>
            ...
            <p><?php echo isset($page_subtitle) ? htmlspecialchars($page_subtitle) : 'System administration panel'; ?></p>
        </div>
    </div>
                ...
                <div class="notification-dropdown-body" id="notificationList">
                    ...
                    <?php else: ?>
                        <?php foreach ($recent_notifications as $notif): ?>
                            <div class="notification-item <?php echo $notif['is_read'] ? '' : 'unread'; ?>" onclick="markAsReadAndGo(<?php echo $notif['notification_id']; ?>, <?php echo $notif['is_read']; ?>)">
...
function markAsReadAndGo(notificationId, isAlreadyRead) {
    if (isAlreadyRead == 1) return; // Already read, do nothing
            ...
            if (data.success) {
                ...
                if (data.notifications.length === 0) {
                    ...
                    data.notifications.forEach(notif => {
                        html += `
                            <div class="notification-item ${notif.is_read == 0 ? 'unread' : ''}" onclick="markAsReadAndGo(${notif.notification_id}, ${notif.is_read})">
                                <div class="notification-content">
